<section>
  <?php
  $count = 0;
  $sql = "SELECT s.id_user, us.usuario FROM usuarios us, seguidores s WHERE s.id_user = '".$user['id']."' AND s.id_user_segue = us.id AND s.id_user != s.id_user_segue";
  ...
  $html_string .= "<table class='main_pub'>";
    ...
    $html_string .= "</table>";
    $html_string .= "<h2>Seguindo: ".$count."</h2>";
    $html_string .= "</div>";
    echo $html_string;
  ?>
</section>
